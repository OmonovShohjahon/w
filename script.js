...
function drawText() {
    ...
    if(frameNumber > 500 && frameNumber < 750){
        ...
        if (window.innerWidth < 600) {           //shortens long sentence for mobile screens
            ...
            context.fillText("Сани канчали севишими блмисан", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 750 && frameNumber < 1000){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("Хар бр коршган пайталримизи есмдан чкаромиман", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber > 2000 && frameNumber < 2250){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("охргача брга бололишимзага ишонама", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 2250 && frameNumber < 2500){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("Взаимоотношение главное", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("Бутун дуньени корсатама озми колим блан", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 2750 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["Муштарий - Юпитер"], canvas.width / 2, (canvas.height/2 + 60), fontSize, lineHeight);
        } else {
            context.fillText("Муштарий - Юпитер", canvas.width/2, (canvas.height/2 + 50));
        }
    ...
    if(frameNumber >= 3000 && frameNumber < 99999){
        ...
        context.fillText("8-март билан асалим", canvas.width/2, (canvas.height/2 + 120));
